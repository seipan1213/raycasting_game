...
/*   Updated: 2021/03/10 16:07:13 by sehattor         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	make_sprite(t_god *g, int x, int *ymask, t_ipair *s_pos)
{
	...
	dl.spriteheight = ft_abs((int)(g->scr_h / (dl.transform.second)));
	dl.drawstarty = ft_max(0, -dl.spriteheight / 2 + g->scr_h / 2);
	dl.drawendy = ft_min(dl.spriteheight / 2 + g->scr_h / 2, g->scr_h - 1);
